...
public class MeldOpenMMLibrary implements Library {
	...
	public static native int OpenMM_MeldForce_addHyperbolicDistanceRestraint(PointerByReference target, int particle1, int particle2, float r1, float r2, float r3, float r4, float force_constant, float asymptote);
	/** Original signature : <code>void OpenMM_MeldForce_modifyHyperbolicDistanceRestraint(OpenMM_MeldForce*, int, int, int, float, float, float, float, float, float)</code> */
	public static native void OpenMM_MeldForce_modifyHyperbolicDistanceRestraint(PointerByReference target, int index, int particle1, int particle2, float r1, float r2, float r3, float r4, float force_constant, float asymptote);
	/** Original signature : <code>int OpenMM_MeldForce_addTorsionRestraint(OpenMM_MeldForce*, int, int, int, int, float, float, float)</code> */
